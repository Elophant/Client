            ...
            while (c != -1)
            {
                ...
                if (c == '&')
                {
                    ...
                    if (c == ';')
                    {
                        ...
                        if (token[1] == '#')
                        {
                            string str = token.ToString().Substring(2, token.Length - 3);

                            if (str[0] == 'x')
                                output.Append((char)int.Parse(str.Remove(0, 1), System.Globalization.NumberStyles.HexNumber));
                            else
                                output.Append((char)int.Parse(str));
                        }
                        else
                        {
